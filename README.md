...
<p align="center">
    <a href="https://github.com/ai-chain/lazycluster/blob/master/LICENSE" title="ML Hub License"><img src="https://img.shields.io/badge/License-Apache%202.0-green.svg"></a>
    <a href="https://gitter.im/ai-chain/lazycluster" title="Chat on Gitter"><img src="https://badges.gitter.im/ai-chain/lazycluster.svg"></a>
    <a href="https://twitter.com/mltooling" title="ML Tooling on Twitter"><img src="https://img.shields.io/twitter/follow/mltooling.svg?style=social"></a>
    <a href="3" title="Lazycluster Test Pipeline"><img src="https://github.com/ai-chain/lazycluster/workflows/build-pipeline/badge.svg"></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/ai-chain/ml-workspace/issues/new?labels=bug&template=01_bug-report.md">Report a Bug</a> •
...
pip install --upgrade git+https://github.com/ai-chain/lazycluster.git@develop
```
...
| Type                     | Channel                                                                                                                                                                                                                                                                                                                                |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🚨 **Bug Reports**       | <a href="https://github.com/ai-chain/lazycluster/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3Abug+sort%3Areactions-%2B1-desc+" title="Open Bug Report"><img src="https://img.shields.io/github/issues/ai-chain/lazycluster/bug.svg"></a>                                                                                   |
| 🎁 **Feature Requests**  | <a href="https://github.com/ai-chain/lazycluster/issues?q=is%3Aopen+is%3Aissue+label%3Afeature-request+sort%3Areactions-%2B1-desc" title="Open Feature Request"><img src="https://img.shields.io/github/issues/ai-chain/lazycluster/feature-request.svg?label=feature%20requests"></a>                                             |
| 👩‍💻 **Usage Questions**   | <a href="https://stackoverflow.com/questions/tagged/ai-chain" title="Open Question on Stackoverflow"><img src="https://img.shields.io/badge/stackoverflow-ml--tooling-orange.svg"></a> <a href="https://gitter.im/ai-chain/lazycluster" title="Chat on Gitter"><img src="https://badges.gitter.im/ai-chain/lazycluster.svg"></a> |
| 🗯 **General Discussion** | <a href="https://gitter.im/ai-chain/lazycluster" title="Chat on Gitter"><img src="https://badges.gitter.im/ai-chain/lazycluster.svg"></a> <a href="https://twitter.com/mltooling" title="ML Tooling on Twitter"><img src="https://img.shields.io/twitter/follow/mltooling.svg?style=social"></a>                                   |
...
- [MongoDB](https://docs.mongodb.com/manual/administration/install-on-linux/) server must be installed on the [manager](#manager).
  - **Note:** When using the [ml-workspace](https://github.com/ai-chain/ml-workspace) as the `master` then you can use the provided install script for MongoDB which can be found under `/resources/tools`.
- [Hyperopt must be installed ](https://github.com/hyperopt/hyperopt) on all `Runtimes` where hyperopt workers will be started
  - **Note:** When using the [ml-workspace](https://github.com/ai-chain/ml-workspace) as hosts for the `Runtimes` then hyperopt is already pre-installed.
...
- **MongoDB or hyperopt are not installed**, i.e. the prerequisites are not yet fulfilled.
  => Ensure that the prerequisites are fulfilled. Consider using [ml-workspace](https://github.com/ai-chain/ml-workspace) to get rid of dependency problems.
...
- Pull requests are encouraged and always welcome. Read [`CONTRIBUTING.md`](https://github.com/ai-chain/lazycluster/tree/master/CONTRIBUTING.md) and check out [help-wanted](https://github.com/ai-chain/lazycluster/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3A"help+wanted"+sort%3Areactions-%2B1-desc+) issues.
- Submit github issues for any [feature enhancements](https://github.com/ai-chain/lazycluster/issues/new?assignees=&labels=feature-request&template=02_feature-request.md&title=), [bugs](https://github.com/ai-chain/lazycluster/issues/new?assignees=&labels=bug&template=01_bug-report.md&title=), or [documentation](https://github.com/ai-chain/lazycluster/issues/new?assignees=&labels=enhancement%2C+docs&template=03_documentation.md&title=) problems.
- By participating in this project you agree to abide by its [Code of Conduct](https://github.com/ai-chain/lazycluster/tree/master/CODE_OF_CONDUCT.md).
